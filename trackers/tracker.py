...
class Tracker:
    ...
    def draw_ellipse(self, frame, bbox, color, track_id = None):
        ...
        x_center, _ = get_center_of_bbox(bbox) # center of the bounding box
    ...
    def draw_team_ball_possession(self, frame, frame_num, team_ball_possession):
        ...
        # calculating team possession   
        
        team_ball_possession_till_frame = team_ball_possession[:frame_num+1]

        team1_num_frames = team_ball_possession_till_frame[team_ball_possession_till_frame==1].shape[0]
        team2_num_frames = team_ball_possession_till_frame[team_ball_possession_till_frame==2].shape[0]
        ...
        cv2.putText(frame, f"Team 1 Possession: {team1_possession*100:.2f}%", (1400, 900), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,0), 3)
        cv2.putText(frame, f"Team 2 Possession: {team2_possession*100:.2f}%", (1400, 950), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,0), 3)
